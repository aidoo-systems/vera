...
- **Trivy container vulnerability scanning in CI** — `aquasecurity/trivy-action` runs after docker build for both backend and frontend images, fails on HIGH/CRITICAL vulns, and attaches CycloneDX SBOMs to release artifacts
