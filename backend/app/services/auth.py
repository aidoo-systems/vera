...
_ALWAYS_ALLOWED_PATHS = frozenset({"/health", "/metrics", "/api/auth/login", "/api/auth/logout", "/api/auth/status", "/api/csrf-token", "/api/license/status", "/internal/license/refresh"})
